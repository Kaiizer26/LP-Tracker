...
(1800, '2025-04-06 14:00:00', 'Normal', 'Blue'),
(2100, '2025-04-07 20:30:00', 'Ranked', 'Red'),
(2400, '2025-04-08 13:15:00', 'Normal', 'Blue'),
(1900, '2025-04-09 22:00:00', 'Ranked', 'Red'),
(2100, '2025-04-10 11:30:00', 'Normal', 'Blue'),
(2300, '2025-04-11 16:00:00', 'Ranked', 'Red'),
(2000, '2025-04-12 15:30:00', 'Normal', 'Blue');
...
(4, 6, 4, 6, 8, 3, 7, 5.0, 220, 16000, 'Top', 25, '{"Flash", "Ghost"}'),
(4, 7, 5, 7, 10, 4, 9, 4.75, 210, 14500, 'ADC', 15, '{"Heal", "Flash"}'),
(5, 8, 6, 8, 5, 2, 14, 9.5, 230, 17000, 'Jungle', 30, '{"Smite", "Flash"}'),
(5, 9, 7, 9, 3, 3, 15, 6.0, 180, 13000, 'Support', -5, '{"Exhaust", "Ignite"}'),
(6, 10, 8, 10, 12, 2, 8, 10.0, 250, 15500, 'Mid', 35, '{"Flash", "Ignite"}'),
(6, 11, 9, 11, 7, 4, 9, 4.0, 190, 12000, 'Top', 10, '{"Flash", "Teleport"}'),
(7, 12, 10, 12, 14, 1, 12, 26.0, 300, 21000, 'ADC', 50, '{"Flash", "Heal"}');
(8, 13, 11, 13, 6, 5, 10, 3.2, 160, 13500, 'Jungle', -20, '{"Smite", "Flash"}'),
(8, 14, 12, 14, 4, 6, 15, 4.0, 140, 11500, 'Support', -15, '{"Exhaust", "Flash"}'),
(9, 15, 13, 15, 11, 3, 9, 7.0, 220, 16500, 'Mid', 20, '{"Flash", "Ignite"}'),
(9, 16, 14, 16, 9, 4, 8, 3.5, 200, 15000, 'Top', -10, '{"Flash", "Ghost"}'),
(10, 17, 15, 17, 13, 2, 11, 6.5, 240, 17500, 'ADC', -5 , '{"Heal", "Flash"}');
(10, 18, 16, 18, 7, 3, 12, 4.0, 180, 12500, 'Jungle', -15, '{"Smite", "Flash"}'),
(11, 19, 17, 19, 5, 4, 14, 3.0, 160, 13000, 'Support', -20 , '{"Exhaust", "Ignite"}'),
(11, 20, 18, 20, 8, 2, 10, 5.0 ,230 ,14000 ,'Mid' ,25 , '{"Flash", "Teleport"}');
